        ...
        html += '<div class="modal-dialog">'
            html += '<div class="modal-content">'
                ...
                html += '<div class="modal-footer justify-content-center">'
                    html += '<button type="button" class="btn btn-danger" data-bs-dismiss="modal" onclick="window.app.wipeSave()">'
            ...
            html += '<div class="modal-content">'
                ...
                html += '<div class="modal-body">'
                    html += '<div class="row g-2">'
                        ...
                        html += '</div>'
                        html += '<div class="col-12 text-center">'
                            html += '<small class="text-normal">' + i18next.t('modalScenario_info') + '</small>'
                        html += '</div>'
                    html += '</div>'
                html += '</div>'
                html += '<div class="modal-footer justify-content-center">'
                    html += '<button type="button" class="btn btn-warning" data-bs-dismiss="modal" onclick="window.app.doClick(\'changeScenario\')">'
