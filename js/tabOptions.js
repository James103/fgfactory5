            ...
            html += '<div class="row gx-2 gy-3">'
                html += '<div class="col-12">'
                    html += '<div class="row g-2">'
                        ...
                        html += '</div>'
                        html += '<div class="col-12">'
                            html += '<div class="row gy-2 gx-2">'
                                html += '<div class="col-12 small">' + i18next.t('screenGame_love') + '</div>'
                                html += '<div class="col-12 small">' + i18next.t('screenGame_iconsBy') + '</span> <a href="https://fontawesome.com/" target="_blank">Fontawesome</a></div>'
                                html += '<div class="col">'
